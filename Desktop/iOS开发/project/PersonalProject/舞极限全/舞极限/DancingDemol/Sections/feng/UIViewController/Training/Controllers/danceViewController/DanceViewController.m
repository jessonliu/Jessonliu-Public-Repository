...
@property (nonatomic, retain) DanceViewTableViewController *tableVC;
...
- (void)configureCellWithModel:(TrainRecommendModel *)model {
    ...
    self.tableVC.frame = CGRectMake(0, CGRectGetMaxY(self.cellImageView.frame), kScreenWidth, kScreenHeight - CGRectGetMaxY(self.cellImageView.frame) - kMargin / 2);
    
}


#pragma mark ---- AddCommendTableView
- (void)AddCommendTableView {
    self.tableVC = [[DanceViewTableViewController alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(self.cellImageView.frame), kScreenWidth, kScreenHeight - CGRectGetMaxY(self.cellImageView.frame) - kMargin)];
